...
import { buttonVariants, type Variants } from ".";
...
describe('<Button />', () => {
  ...
  describe('default props and JSX', () => {
    ...
    test('verify if default JSX properties work correctly', async () => {
      ...
      render(<Button onClick={handleClick} aria-hidden='false' type="submit">Test</Button>);
  ...
  describe('variants (colors)', () => {
    const allVariants: Variant[] = ['default', 'destructive', 'outline', 'secondary', 'ghost', 'link'];
